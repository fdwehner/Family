...
class AuthenticationTest extends TestCase
{
    ...
    public function test_users_can_register_and_are_redirected_to_the_grocery_list(): void
    {
    ...
    public function test_authenticated_users_are_redirected_away_from_guest_pages(): void
    {
        ...
        $this->actingAs($user)->get(route('login'))->assertRedirect(route('groceries.index'));
        $this->actingAs($user)->get(route('home'))->assertRedirect(route('groceries.index'));
    }
}
